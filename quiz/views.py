...
from .forms import TeacherRegister, StudentInterestsForm,StudentSignUpForm, TakeQuizForm, BaseAnswerInlineFormSet, QuestionForm, TeacherSignUpForm
...
from bootstrap_modal_forms.generic import (BSModalCreateView, BSModalDeleteView, BSModalLoginView, BSModalReadView, BSModalUpdateView)
...
class QuestionDeleteView(BSModalDeleteView):
    ...
    success_message = 'Success: Question was successfully deleted'
...
class TeachereRegistration(BSModalCreateView):
...
class QuizDelete(BSModalDeleteView):
    template_name = 'classroom/teachers/quiz_delete.html'
    model = Quiz
    success_message = 'Success: Quiz successfully deleted'
    success_url = reverse_lazy('teachers:quiz_change_list')
...
class ResultsView(BSModalReadView):
    model = Quiz
    context_object_name = 'quiz'
    template_name = 'classroom/teachers/quizresults.html'
...
class Create_YearLevel(BSModalCreateView):
    template_name = 'classroom/teachers/year_level.html'
    form_class = Year_LevelForm
    success_message = 'Success: Year Level successully created'
    success_url = reverse_lazy('teachers:quiz_add')
